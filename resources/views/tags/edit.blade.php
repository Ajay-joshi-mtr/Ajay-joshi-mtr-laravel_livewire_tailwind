<div>
    ...
    <div class=" flex flex-col sm:flex-row sm:items-center items-start mx-auto">
        ...
        <a href="{{ route('tags.index') }}" class="float-left flex-shrink-0 text-white bg-purple-500 border-0 py-1 px-2 focus:outline-none hover:bg-purple-600 rounded text-sm lg:mt-10 mt-2">Back</a>
    </div>
    @endsection

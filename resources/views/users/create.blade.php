<div>
  ...
  <div class=" flex flex-col sm:flex-row sm:items-center items-start mx-auto">
    ...
    <a href="{{ route('users.index') }}" class="float-left flex-shrink-0 text-white bg-purple-500 border-0 py-1 px-2 focus:outline-none hover:bg-purple-600 rounded text-sm mt-0 lg:mt-10">Back</a>
  </div>
  @endsection
    ...
    <x-slot name="card_body">
      ...
      <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2 dark:border-gray-700  dark:text-gray-400 dark:bg-gray-800">
        <form method="POST" wire:submit.prevent="store">
          ...
          <div class="-mx-3 md:flex mb-6">
            <div class="md:w-full px-3 lg:mb-0 mb-4">
          ...
          <div class="-mx-3 md:flex mb-2">
            <div class="md:w-1/2 px-3 mb-6 md:mb-0">
              ...
              <x-inputs.text key="user.city" autofocus placeholder="City" />
              @error('user.city') <p class="text-red-600 text-xs italic">{{ $message }} </p> @enderror
            </div>
            <div class="md:w-1/2 px-3 lg:mb-0 mb-4">
              <label class="block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2" for="grid-state">
                State
              </label>
              <div class="relative">
                <x-inputs.text key="user.state" autofocus placeholder="State" />
          ...
          <div class="-mx-3 md:flex mb-2 mt-4">
            <div class="md:w-1/2 px-3 mb-6 md:mb-0">
              ...
              <x-inputs.password key="user.password" />
            </div>
          </div>

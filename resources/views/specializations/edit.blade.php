                ...
                <form method="POST" wire:submit.prevent="update">
                    ...
                    <div class="w-full">
                            ...
                            <div class="md:flex mb-6">
                                <div class="w-full px-3 mb-6 md:mb-0">
                                    ...
                                    <div style="border: 2px dashed gray; padding:4px;">
                                        ...
                                        <!-- <div>Old File : {{ $specialization->media?$specialization->media->name:'No File Available' }}</div> -->
                        ...
                        <div class="lg:w-2/5 px-3 align-top lg:inline-block">
                            ...
                            <img src="{{ $specializationImage->temporaryUrl() }}" alt="No Image Found" style="max-height:13em;">
                            @else
                            <img src="{{ $specialization->media ? asset('/storage'.$this->specialization->media->path) : '' }}" alt="No Image Found" style="max-height:13em;">
                            @endif
                        </div>
                    </div>

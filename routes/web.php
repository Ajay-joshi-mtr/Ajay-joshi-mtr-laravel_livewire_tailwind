...
use App\Httkkp\Controllers\ConfirmedEmailController;
...
use App\Http\Livewire\Type\IndexTypeComponent;
use App\Http\Livewire\Type\CreateTypeComponent;
use App\Http\Livewire\Type\EditTypeComponent;
use App\Http\Livewire\Permission\CreatePermissionComponent;
use App\Http\Livewire\Permission\EditPermissionComponent;
use App\Http\Livewire\Permission\IndexPermissionComponent;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::group(
        ...
        function () {
            ...
            Route::get('/{user}', [ProfileUserController::class, 'getUser'])->name('profile.users.getUser');
        }
    );
    ...
    Route::middleware(['authorization'])->group(function () {
        ...
        Route::get('permissions', IndexPermissionComponent::class)->name('permissions.index');

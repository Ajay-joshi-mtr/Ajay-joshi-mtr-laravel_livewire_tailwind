  ...
  <div class="grid gap-6 mb-8 md:grid-cols-2">
    <div class="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
      ...
      <div class="flex justify-center mt-4 space-x-3 text-sm text-gray-600 dark:text-gray-400">
        <!-- Chart legend -->
        <div class="flex items-center">
          <span class="inline-block w-3 h-3 mr-1 bg-orange-500 rounded-full" style="background-color: #ff5a1f;"></span>
          <span>Pending</span>
        </div>
        <div class="flex items-center">
...
<script>
  ...
  const pieConfig = {
    ...
    data: {
      datasets: [{
        data: [<?php echo json_encode($requests_pending); ?>, <?php echo json_encode($requests_approved); ?>],
        /**
         * These colors come from Tailwind CSS palette
         * https://tailwindcss.com/docs/customizing-colors/#default-color-palette
         */
        backgroundColor: ['#ff5a1f', '#047481', '#7e3af2'],
...
<script>
  ...
  const pieConfig = {
    ...
    data: {
      datasets: [{
        data: [<?php echo json_encode($my_requests_pending); ?>, <?php echo json_encode($my_requests_approved); ?>],
        /**
         * These colors come from Tailwind CSS palette
         * https://tailwindcss.com/docs/customizing-colors/#default-color-palette
         */

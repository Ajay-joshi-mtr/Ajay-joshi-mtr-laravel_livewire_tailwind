...
<div class=" flex flex-col sm:flex-row sm:items-center items-start mx-auto">
    ...
    <a href="{{ route('roles.index') }}" class="float-left flex-shrink-0 text-white bg-purple-500 border-0 py-1 px-2 focus:outline-none hover:bg-purple-600 rounded text-sm mb-4 lg:-mb-16">Back</a>
</div>
@endsection
...
<x-savings.content>
    ...
    <x-slot name="card_body">
        <form wire:submit.prevent="update" method="POST" class="dark:text-gray-400">
            @csrf

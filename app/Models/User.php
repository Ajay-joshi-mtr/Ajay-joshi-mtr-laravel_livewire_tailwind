...
class User extends Authenticatable
{
    ...
    protected $fillable = ['full_name', 'mobile', 'address', 'role_id', 'password', 'email', AppServiceProvider::OWNER_FIELD, 'image', 'pincode', 'state', 'city', 'mobile_alt'];
    ...
    public function chapterRequests()
    {
        return $this->hasMany(ChapterRequest::class, 'requester_id');
    }

    public function allChapterRequests()
    {
        return $this->hasMany(ChapterRequest::class);
    }
